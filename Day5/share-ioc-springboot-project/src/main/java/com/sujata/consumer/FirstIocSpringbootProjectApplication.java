...
2. scans classes and
check for classes annotated with @Component
and run those classes life cycle which either annotated with @Componenet or
is specified in Configuartion class
 */
